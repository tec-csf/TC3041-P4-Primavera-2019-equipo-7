...
for i in range(5000000):
    ...
    temperatura1 = {'measurement': 'temperatura',
                   'tags':{'ubicacion':'fuera'},
                   'time':datetime.datetime.utcnow().isoformat(),
                   'fields': {'gradosCentigrados':random1}}
    temperatura2 = {'measurement': 'temperatura',
...
for i in range(5000000):
    ...
    humedadObj1 = {'measurement': 'humedad',
                   'tags':{'ubicacion':'fuera'},
                   'time':datetime.datetime.utcnow().isoformat(),
                   'fields': {'porcentajeHumedad':humedadFuera}}
    humedadObj2 = {'measurement': 'humedad',
                   'tags':{'ubicacion':'dentro'},
                   'time':datetime.datetime.utcnow().isoformat(),
                   'fields': {'porcentajeHumedad':humedadDentro}}
    humedadArr.append(humedadObj1)
    humedadArr.append(humedadObj2)
